...
// GetLeagueInformation provides a mock function with given fields: userID
func (_m *LeaguesDAO) GetLeagueInformation(userID int) (*databaseAccess.LeagueInformation, error) {
