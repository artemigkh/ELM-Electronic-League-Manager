...
//	}
//
//	id, err := LeaguesDAO.AddRecurringAvailability(ctx.GetInt("getLeagueId"),
...
//	}
//
//	teamSummary, err := LeaguesDAO.GetTeamSummary(ctx.GetInt("getLeagueId"))
//	var teamIds []int
...
//
//	availabilities, err := LeaguesDAO.GetSchedulingAvailabilities(ctx.GetInt("getLeagueId"))
//	if checkErr(ctx, err) {
//		return
//	}
//
...
//
//	leagueInformation, err := LeaguesDAO.GetLeagueInformation(ctx.GetInt("getLeagueId"))
//	if checkErr(ctx, err) {
//		return
//	}
//
...
//	g.DELETE("/recurringAvailability/:id", storeUrlId(), authenticate(), failIfNotLeagueAdmin(), deleteRecurringAvailability)
