...
// HasEditSchedulePermission provides a mock function with given fields: leagueId, userId
func (_m *LeaguesDAO) HasEditSchedulePermission(leagueId int, userId int) (bool, error) {
	ret := _m.Called(leagueId, userId)
